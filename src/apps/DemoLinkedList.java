...
public class DemoLinkedList {
    public static void main(String[] args) {
        ...
        addInOrder(placesToVisit,"Brisbame");
    ...
    public static void visit(LinkedList cities){
        ...
        boolean quit = false;
        boolean goingForward = true; // for setting the direction
        ListIterator<String> listIterator = cities.listIterator();

        if(cities.isEmpty()){
            System.out.println("No cities in the itennerary");
            return;
        } else{
            ...
            switch(action) {
                ...
                case 1:
                    ...
                    if(listIterator.hasNext()){
                        ...
                        goingForward = false; // there's no more way to go forward
                    }
                    break;
                case 2:
                    if(goingForward){
